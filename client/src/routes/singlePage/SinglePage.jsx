...
function SinglePage() {
  ...
  if (!post.postDetail) {
    return <div>Post details are missing. Please update this post.</div>
  }
      ...
      <div className='details'>
        <div className="wrapper">
          ...
          <div className="info">
            ...
            <div className="bottom" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(post?.postDetail?.desc || "No description available") }}>
            </div>
          </div>
        </div>
      </div>
